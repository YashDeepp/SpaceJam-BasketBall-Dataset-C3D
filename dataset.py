...
class BasketballDataset(Dataset):
    ...
    #             # Video not present in the original directory, remove from augment_list
    #             print(f"Video {video_id} not found in the original directory. Removing from augment_list.")
    ...
    def VideoToNumpy(self, video_id):
        ...
        if not video.isOpened():
            raise Exception(f"{video_id} Video file not readable")
